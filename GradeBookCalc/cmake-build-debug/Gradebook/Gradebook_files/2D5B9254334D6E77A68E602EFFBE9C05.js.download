...
Draggable.prototype = {
  initialize: function(element) {
    var defaults = {
      ...
      endeffect: function(element) {
        ...
        // Callers can set _originalOpacity manually prior to starting dragdrop if they know they're going to change the opacity themselves during the dragdrop operation.
        // See portalmodule.js for an example.
        if( element._originalOpacity ) {
          toOpacity = element._originalOpacity;
        }
  ...
  finishDrag: function(event, success) {
    ...
    if(this.options.zindex)
      this.element.style.zIndex = this.originalZ ? this.originalZ : '';
